...
- **Цель**:  
  Проведение A/B теста для изменения структуры скидок с целью повышения маржинальности товаров, особенно в категориях с низкой маржинальностью (молочные продукты, хлебобулочные изделия), без снижения объема продаж.
- **Действия**:  
...
- **Результаты**:  
  - Увеличение маржинальности категории на 12% в экспериментальной группе.  
  - Рост среднего чека на 7%.  
  - Увеличение количества покупок сопутствующих товаров на 15%.  
- **Рекомендации**:  
...
- **Визуализация**:  
  Для анализа использована карта метрик, разработанная в Miro. Визуализация демонстрирует динамику маржинальности, среднего чека и количества покупок сопутствующих товаров.  
...
- **Визуализация**: Карта метрик оформлена в Miro и доступена по ссылке: [Дашборд в Miro] (https://miro.com/welcomeonboard/NVM1Y1FkWEFNdXdPU2EyY05BK2dXK0UrSit0R1ZzT2k1NWdyZmVobVY0ZnZMZ1h0dWZPQTQ1a1RlUFI1WlZjcjJ2cVJtSnFOckM3cmlWZVowS2tpUVJKVXhLRGF4TFpjNkxUc2lpanZNSmtJTG91TnpMV3JWUVdmYkRTckhOZFRzVXVvMm53MW9OWFg5bkJoVXZxdFhRPT0hdjE=?share_link_id=94671776741).
...
- **Визуализация в Miro**: Lean Canvas оформлен в Miro и доступен по ссылке: [Дашборд в Miro] (https://miro.com/welcomeonboard/dEJ4ZW1pLzN4aytNSzFVK011QkFTM3dKRlJ3NWRoMnZOblpLdXVhR0gxcCtMVVB1eGoxeUVvKzVLWDNNQUpmaS82WUtNZEExa25yYkxRUnd0K3JtdFJKVXhLRGF4TFpjNkxUc2lpanZNSmxNU0lFdzY4Z3ZPbmtJRnplQWhqVWRzVXVvMm53MW9OWFg5bkJoVXZxdFhRPT0hdjE=?share_link_id=568255695557).
